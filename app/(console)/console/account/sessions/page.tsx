...
export default async function ConsoleAccountSessionsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        <h3 className="mb-3 text-sm font-semibold text-ink-900 dark:text-slate-100">{t("sessions.consoleSection")}</h3>
      ...
      <section>
        <h3 className="mb-3 text-sm font-semibold text-ink-900 dark:text-slate-100">{t("sessions.appSection")}</h3>
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
