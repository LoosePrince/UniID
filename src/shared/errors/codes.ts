...
export const ErrorCodes = {
  ...
  AUTH_REGISTRATION_DISABLED: { http: 403, message: "注册功能已关闭" },
  AUTH_REGISTER_EMAIL_VERIFICATION_REQUIRED: { http: 400, message: "注册需要先验证邮箱" },
  AUTH_REGISTER_EMAIL_VERIFICATION_INVALID: { http: 401, message: "注册邮箱验证码无效或已过期" },
  AUTH_CHANGE_PASSWORD_INVALID_OLD: { http: 400, message: "原密码不正确" },
  AUTH_EMAIL_ALREADY_VERIFIED: { http: 409, message: "邮箱已完成验证" },
  AUTH_EMAIL_VERIFICATION_DISABLED: { http: 403, message: "邮箱验证功能已关闭" },
  AUTH_EMAIL_REQUIRED: { http: 400, message: "当前账号未绑定邮箱" },
  AUTH_MFA_DISABLED: { http: 403, message: "两步验证功能已关闭" },
